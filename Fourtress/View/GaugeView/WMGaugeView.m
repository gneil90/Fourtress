...
- (void)initialize;
{
    _style = [WMGaugeViewStyleFlatThin new];
    _showInnerRim = NO;
    ...
    _scaleDivisions = 7;
    _scaleSubdivisions = 3;
    _showScale = YES;
    _showScaleShadow = NO;
    _scalesubdivisionsAligment = WMGaugeViewSubdivisionsAlignmentCenter;
    ...
    _scaleDivisionColor = RGB(255, 255, 255);
